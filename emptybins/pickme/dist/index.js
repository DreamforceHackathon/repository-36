...
module.exports = function(__obj) {
  ...
  (function() {
    (function() {
      __out.push('\n<div class="placeholder">\n\n<div data-type="recycle" class="button_click button_click_recycle"></div>\n\n<div  data-type="recycle" class="button_click button_click_compost"></div>\n\n<div  data-type="recycle" class="button_click button_click_landfill"></div>\n\n');
...
},{"3vot-model":13,"3vot-model/lib/3vot-model-vfr-sfc":10}],7:[function(require,module,exports){
var _3Model = require("3vot-model")
var Ajax = require("3vot-model/lib/3vot-model-vfr-sfc");
...
module.exports= Case
},{"3vot-model":13,"3vot-model/lib/3vot-model-vfr-sfc":10}],8:[function(require,module,exports){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
start('abc');
},{"./code/detail":3,"./code/item":4,"./code/layout":5,"./code/models/account":6,"./code/models/case":7,"./code/year":8,"3vot-model/lib/3vot-model-vfr-sfc":10}],10:[function(require,module,exports){
...
},{"./3vot-vfr":11}],11:[function(require,module,exports){
var Q = require("kew");
...
},{"kew":15}],12:[function(require,module,exports){
...
__slice = [].slice;
},{"../utils/model":16,"./events":12,"./module":14}],14:[function(require,module,exports){
