...
module.exports = function(__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="product-detail" style="padding-bottom: 15px;">\n\t<div class="product-title">');
    
      __out.push(__sanitize(this.Name));
    
      __out.push('</div>\n\n\t<div class="product-image"></div>\n\n\t<textarea placeholder="Leave a comment" class="product-comment"></textarea>\n\n\t<div class="btns">\n\n\t\t<div id="reportbtn"  data-type="report" class="product-button">Report a Problem</div>\n\n\t\t<div id="askbtn" style="display: none" class="half_button">\n\t\t\t<span  data-type="damage" data-damage="damages"  class="half">Damages?</span>\n\t\t\t<span class="divider"></span>\n\t\t\t<span  data-type="other" data-damage="other" class="half product-button__halfright">Other?</span>\n\t\t</div>\n\n\t\t<div id="thanksbtn"  style="display: none" data-type="thanks" class="product-button">Thank You</div>\n\n\t</div>\n\n</div>\n');
...
function Detail(container, product){
	...
	function createCase(type){
		...
		Case.create({ 
			...
			"Type": type,
			"Subject": "Damage for " + product.Name  ,
			"Origin":"Customer App",
...
},{"../models/account":6,"../models/case":7,"./detail":2}],4:[function(require,module,exports){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
  ...
  (function() {
    (function() {
      __out.push('<li class="product-item" data-id="');
...
module.exports = function(__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="logo"></div>\n\n<div style="margin-bottom:10px;" class="msg">Hello, <span class="name"></span></div>\n<div class="msg">Browse the list of your<br/>purchases at Shelfie:</div>\n\n\n\n<ul class="oppList list-unstyled">\n\n\n</ul>');
...
},{"3vot-model":14,"3vot-model/lib/3vot-model-vfr-sfc":11}],7:[function(require,module,exports){
var _3Model = require("3vot-model")
var Ajax = require("3vot-model/lib/3vot-model-vfr-sfc");
...
module.exports= Case
},{"3vot-model":14,"3vot-model/lib/3vot-model-vfr-sfc":11}],8:[function(require,module,exports){
var _3Model = require("3vot-model")
var Ajax = require("3vot-model/lib/3vot-model-vfr-sfc");
...
module.exports= Opp
},{"3vot-model":14,"3vot-model/lib/3vot-model-vfr-sfc":11}],9:[function(require,module,exports){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
start('abc');
},{"./code/detail":3,"./code/item":4,"./code/layout":5,"./code/models/account":6,"./code/models/oportunity":8,"./code/year":9,"3vot-model/lib/3vot-model-vfr-sfc":11}],11:[function(require,module,exports){
...
},{"./3vot-vfr":12}],12:[function(require,module,exports){
var Q = require("kew");
...
},{"kew":16}],13:[function(require,module,exports){
...
__slice = [].slice;
},{"../utils/model":17,"./events":13,"./module":15}],15:[function(require,module,exports){
